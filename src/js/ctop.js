...
ctopTapply['rem'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 3, p, 'mod', a);
};

ctopTapply['divide'] = function (nn, n, f, a, b, q, p) {
    var mf = ctopE('mfrac');
    ctopAT(mf, a[0], 0);
    ctopAT(mf, a[1], 0);
    nn.appendChild(mf);
...
ctopTapply['remainder'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 3, p, 'mod', a);
};
ctopTapply['implies'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 3, p, '\u21D2', a);
};
ctopTapply['factorof'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 3, p, '\u21D2', a);
};
ctopTapply['in'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 3, p, '\u2208', a);
};
ctopTapply['notin'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 3, p, '\u2209', a);
};
ctopTapply['notsubset'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 2, p, '\u2288', a);
};
ctopTapply['notprsubset'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 2, p, '\u2284', a);
};
ctopTapply['setdiff'] = function (nn, n, f, a, b, q, p) {
    ctopB(nn, n, 2, p, '\u2216', a);
};
...
ctopT['naturalnumbers'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u2115');
};
ctopT['integers'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u2124');
};
ctopT['reals'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u211D');
};
ctopT['rationals'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u211A');
};
ctopT['complexes'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u2102');
};
ctopT['primes'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u2119');
};
ctopT['exponentiale'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', 'e');
};
ctopT['imaginaryi'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', 'i');
};
ctopT['notanumber'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', 'NaN');
};
ctopT['eulergamma'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u03B3');
};
ctopT['gamma'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u0263');
};
ctopT['pi'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u03C0');
};
ctopT['infinity'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u221E');
};
ctopT['emptyset'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', '\u2205');
};
ctopT['true'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', 'true');
};
ctopT['false'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', 'false');
};
...
const ctopI = function (nn, f, a, p, tp, s) {
    var mf = ctopE('mrow');
    if (p > tp) {
        ctopAppendTok(mf, 'mo', '(');
    }
...
ctopTapply['eq'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '=');
};
ctopTapply['compose'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '\u2218');
};
ctopTapply['left_compose'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '\u2218');
};
ctopTapply['and'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '\u2227');
};
ctopTapply['or'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 3, '\u2228');
};
ctopTapply['xor'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 3, 'xor');
};
ctopTapply['neq'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '\u2260');
};
ctopTapply['gt'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '<');
};
ctopTapply['lt'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '>');
};
ctopTapply['geq'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '\u2265');
};
ctopTapply['leq'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '\u2264');
};
ctopTapply['equivalent'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '\u2261');
};
ctopTapply['approx'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 1, '\u2243');
};
ctopTapply['union'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '\u222A');
};
ctopTapply['intersect'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 3, '\u2229');
};
ctopTapply['subset'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '\u2286');
};
ctopTapply['prsubset'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '\u2282');
};
ctopTapply['cartesianproduct'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '\u00D7');
};
ctopTapply['cartesian_product'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '\u00D7');
};
ctopTapply['vectorproduct'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '\u00D7');
};
ctopTapply['scalarproduct'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '.');
};
ctopTapply['outerproduct'] = function (nn, n, f, a, b, q, p) {
    ctopI(nn, f, a, p, 2, '\u2297');
};

ctopT['set'] = function (nn, n, p) {
    ctopS(nn, ctopChildren(n), '{', '}');
};
ctopTapply['set'] = function (nn, n, f, a, b, q, p) {
    ctopS(nn, a, '{', '}');
};
ctopT['list'] = function (nn, n, p) {
    ctopS(nn, ctopChildren(n), '(', ')');
};
ctopTapply['list'] = function (nn, n, f, a, b, q, p) {
    ctopS(nn, a, '(', ')');
};
...
ctopTapply['sum'] = function (nn, n, f, a, b, q, p) {
    ctopO(nn, f, a, b, q, p, '\u2211');
};

ctopTapply['product'] = function (nn, n, f, a, b, q, p) {
    ctopO(nn, f, a, b, q, p, '\u220F');
};
...
ctopTapply['forall'] = function (nn, n, f, a, b, q, p) {
    ctopBd(nn, f, a, b, q, p, '\u2200');
};
ctopTapply['exists'] = function (nn, n, f, a, b, q, p) {
    ctopBd(nn, f, a, b, q, p, '\u2203');
};
ctopTapply['lambda'] = function (nn, n, f, a, b, q, p) {
    ctopBd(nn, f, a, b, q, p, '\u03BB');
};
...
ctopT['ident'] = function (nn, n, p) {
    ctopAppendTok(nn, 'mi', 'id');
};
...
ctopTapply['root'] = function (nn, n, f, a, b, q, p) {
    ...
    if (
        f.localName == 'root' &&
        (q.length == 0 || (q[0].localName == 'degree' && q[0].textContent == '2'))
    ) {
        mr = ctopE('msqrt');
        for (var i = 0; i < a.length; i++) {
            ctopAT(mr, a[i], 0);
...
ctopT['semantics'] = function (nn, n, p) {
    ...
    if (c.length) {
        ...
        for (var i = 0; i < c.length; i++) {
            if (
                c[i].localName == 'annotation-xml' &&
                c[i].getAttribute('encoding') == 'MathML-Presentation'
            ) {
                z = c[i];
                break;
            }
